...
export const about = {
  ...
  introduction: {
    ...
    storyParagraphs: [
      ...
      "After <strong>12 years of hard work, dedication, Countless Sleepless nights  and continuous growth</strong>, we took an important step forward in <strong>2010</strong> by moving into our own <strong>7,500-square-foot building</strong>. This milestone marked an important chapter in our journey — from a small <strong>300-square-foot rented space</strong> to a facility of our own, built through years of commitment and perseverance.",
  ...
  legacy: {
    ...
    desc1:
      "Founded with a vision to streamline pharmaceutical distribution, Meenakshi Pharma has grown into a major regional player. We began our journey with a small warehouse and a handful of clients, but our unwavering commitment to quality and service quickly set us apart.",
    desc2:
      "Today, we operate a sophisticated logistics network that spans multiple districts, serving pharmacies, hospitals, and clinical institutions. Our growth is built on the trust of our partners and our relentless pursuit of excellence.",
    imageUrl:
    ...
    list: [
      {
        ...
        desc: "We maintain absolute transparency and ethical standards in all operations and partnerships.",
      },
      {
        title: "Uncompromising Quality",
        desc: "Every product we distribute goes through strict temperature and quality verification controls.",
      },
      {
        title: "Customer Obsession",
        desc: "We go the extra mile to fulfill critical medication requests and ensure on-time deliveries.",
      },
    ],
  },
  team: {
    ...
    members: [
      {
        ...
        desc: "Over 25 years of pharmaceutical industry experience guiding our strategic expansion.",
        img: "https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=1374&auto=format&fit=crop",
      },
      {
        name: "Jane Smith",
        role: "Head of Operations",
        desc: "Ensures logistics efficiency and state-of-the-art cold chain tracking compliance.",
        img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=1376&auto=format&fit=crop",
      },
      {
        name: "Robert Johnson",
        role: "Quality Assurance Director",
        desc: "Upholds our WHO-GMP and ISO standards across all supply chain facilities.",
        img: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?q=80&w=1374&auto=format&fit=crop",
      },
    ],
  },
};
...
export const services = {
  seo: {
    ...
    description:
      "Explore our range of healthcare distribution services, cold chain logistics, and specialty medicine supplies.",
  },
  banner: {
    title: "Our Services",
    subtitle:
      "We offer comprehensive distribution solutions designed to meet the complex needs of modern healthcare.",
  },
  list: [
    {
      icon: "activity",
...
export const career = {
  seo: {
    ...
    description:
      "Join our team and build a rewarding career in healthcare distribution.",
  },
  banner: {
    title: "Join Our Team",
