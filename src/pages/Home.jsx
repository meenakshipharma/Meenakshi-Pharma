...
const Home = () => {
  ...
  const services = [
    { icon: <FiBox className="text-4xl text-brand" />, title: 'Pharmaceutical Distribution', desc: 'Reliable and timely distribution of high-quality medicines.' },
    { icon: <FiTruck className="text-4xl text-brand" />, title: 'Cold Chain Logistics', desc: 'Temperature-controlled supply chain for sensitive products.' },
    { icon: <FiShield className="text-4xl text-brand" />, title: 'Quality Assurance', desc: 'Strict compliance with pharmaceutical safety standards.' },
    { icon: <FiActivity className="text-4xl text-brand" />, title: 'Super-Specialty Care', desc: 'Providing life-saving critical care medications.' },
    { icon: <FiUsers className="text-4xl text-brand" />, title: 'Retail Pharmacy Support', desc: 'Comprehensive support for our retail partners.' },
    { icon: <FiTrendingUp className="text-4xl text-brand" />, title: 'Inventory Management', desc: 'Advanced tracking and stock management solutions.' },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Delivering excellence in pharmaceutical distribution with a commitment to quality, reliability, and healthcare advancement." />
      </Helmet>
        ...
        <div className="container-custom relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-6xl xl:text-7xl font-serif text-text leading-tight mb-6">
              Delivering <span className="text-brand">Excellence</span> in Healthcare
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
              ...
              <Button to="/partner" variant="secondary">Partner With Us</Button>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-text-light font-medium">Certified</p>
                  <p className="font-serif font-bold text-lg text-text">Quality Assured</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="container-custom">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <SectionTitle title="A Legacy of Trust in Healthcare" subtitle="About Meenakshi Pharma" align="left" />
      ...
      <section className="section-padding bg-transparent">
        <div className="container-custom">
          <SectionTitle title="Comprehensive Healthcare Solutions" subtitle="Our Services" />
