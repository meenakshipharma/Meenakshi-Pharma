      ...
      >
        ...
        <g className="animate-float" style={{ transformOrigin: "center" }}>
          <g transform="translate(180, 140)">
            <path
              d="M40 0 H80 A30 30 0 0 1 110 30 V60 H10 V30 A30 30 0 0 1 40 0 Z"
              fill="url(#capsule-grad-white)"
              stroke="#E2E8F0"
              strokeWidth="1.5"
            />
            <path
              d="M10 60 H110 V90 A30 30 0 0 1 80 120 H40 A30 30 0 0 1 10 90 Z"
              fill="url(#capsule-grad-blue)"
            />
            <rect
              x="52"
              y="48"
        ...
        <g className="animate-float-slow">
          <path
            d="M90 140 h15 v-15 h10 v15 h15 v10 h-15 v15 h-10 v-15 h-15 z"
            fill="#1BD3E4"
            opacity="0.7"
          />
          <path
            d="M380 280 h10 v-10 h8 v10 h10 v8 h-10 v10 h-8 v-10 h-10 z"
            fill="#10B981"
            opacity="0.6"
          />
        </g>
        ...
        <g transform="translate(310, 160)" className="animate-float">
          <path
            d="M30 0 h20 v20 l40 70 A15 15 0 0 1 77 110 H3 A15 15 0 0 1 -7 90 l40 -70 z"
            fill="none"
            stroke="#64748B"
            strokeWidth="3"
            strokeLinecap="round"
          ...
          />
          <path
            d="M12 50 l56 0 l22 36 A10 10 0 0 1 81 100 H-1 A10 10 0 0 1 -9 86 z"
            fill="#1BD3E4"
            opacity="0.3"
          />
    ...
    <div className="w-full max-w-[420px] aspect-square relative flex items-center justify-center">
      ...
      >
        ...
        >
          ...
          <path
            d="M100 230 C 150 180, 350 180, 400 230"
            fill="none"
            strokeWidth="1.5"
          />
        </g>
        ...
        <g transform="translate(320, 100)" className="animate-float">
          <path
            d="M15 0 C 6.7 0, 0 6.7, 0 15 C 0 26.2, 15 42, 15 42 C 15 42, 30 26.2, 30 15 C 30 6.7, 23.3 0, 15 0 Z"
            fill="#10B981"
          />
        ...
        <g className="animate-float" style={{ transformOrigin: "center" }}>
          <g transform="translate(140, 200)">
            ...
            />
            <path
              d="M10 30 h130 a15 15 0 0 1 15 15 v45 a10 10 0 0 1 -10 10 h-135 a10 10 0 0 1 -10 -10 v-45 a15 15 0 0 1 15 -15 z"
              fill="url(#van-blue)"
            />
            <path
              d="M140 30 h25 a5 5 0 0 1 5 5 v30 l-30 10 z"
              fill="#FFFFFF"
              opacity="0.25"
            />
            <circle
        ...
        <g className="animate-float-slow">
          <path
            d="M380 180 h12 v-12 h8 v12 h12 v8 h-12 v12 h-8 v-12 h-12 z"
            fill="#1BD3E4"
            opacity="0.8"
          />
          <path
            d="M80 270 h10 v-10 h6 v10 h10 v6 h-10 v10 h-6 v-10 h-10 z"
            fill="#10B981"
            opacity="0.6"
          />
        </g>
      ...
      >
        ...
        <g className="animate-float" style={{ transformOrigin: "center" }}>
          <g transform="translate(185, 140)">
            <path
              d="M0 10 C 40 10, 60 0, 65 0 C 70 0, 90 10, 130 10 C 130 70, 65 120, 65 120 C 65 120, 0 70, 0 10 Z"
              fill="url(#shield-grad)"
              stroke="#FFFFFF"
              strokeWidth="3.5"
              filter="drop-shadow(0 12px 25px rgba(16,185,129,0.25))"
            />
            <path
              d="M40 55 L 58 73 L 92 38"
              stroke="#FFFFFF"
              strokeWidth="7"
              fill="none"
              strokeLinecap="round"
        ...
        <g className="animate-float" style={{ transformOrigin: "center" }}>
          <g transform="translate(320, 230)">
            ...
            />
            <text x="12" y="12" fontSize="7" fontWeight="bold" fill="#FFFFFF">
              100% GENUINE
            </text>
            <line
              x1="15"
        ...
        <g className="animate-float-slow">
          <path
            d="M120 120 h10 v-10 h8 v10 h10 v8 h-10 v10 h-8 v-10 h-10 z"
            fill="#1BD3E4"
            opacity="0.7"
          />
          <path
            d="M370 120 h10 v-10 h8 v10 h10 v8 h-10 v10 h-8 v-10 h-10 z"
            fill="#10B981"
            opacity="0.6"
          />
        </g>
    ...
    <div className="relative bg-[#F8FCFD] min-h-screen">
      ...
      >
        ...
        <div className="absolute inset-0 z-0 pointer-events-none opacity-65">
          ...
          <svg
            className="absolute top-1/4 left-10 w-24 h-24 text-cyan-200/20 fill-current"
            viewBox="0 0 24 24"
          >
            <path d="M19 10.5h-5.5V5c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v5.5H5c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5h5.5V19c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5v-5.5H19c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5z" />
          </svg>
          <svg
            className="absolute bottom-1/4 right-16 w-32 h-32 text-cyan-200/15 fill-current"
            viewBox="0 0 24 24"
          >
            <path d="M19 10.5h-5.5V5c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v5.5H5c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5h5.5V19c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5v-5.5H19c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5z" />
          </svg>
          ...
          <svg
            className="absolute top-12 right-1/3 w-20 h-20 text-cyan-200/15 fill-none stroke-current stroke-1"
            viewBox="0 0 100 100"
          >
              ...
              <div className="lg:col-span-7 flex flex-col items-start text-left">
                ...
                >
                  {currentSlide.id === 1 ? (
                    <>
                      Trichy's Leading{" "}
                      <span className="text-primary">Pharma</span> Distributor
                    </>
                  ) : (
              ...
              <button
                ...
                className={`h-2.5 rounded-full transition-all duration-300 cursor-pointer focus:outline-none ${
                  activeSlide === idx
                    ...
                    : "w-2.5 bg-slate-300 opacity-60 hover:opacity-100"
                }`}
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            {COMPANY_STATS.map((stat, i) => (
              <div
                key={i}
                className="flex flex-col items-center text-center p-4 border-r last:border-0 border-slate-100 lg:odd:border-r lg:even:border-r"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10 items-stretch pt-8">
            {HOME_SERVICES_CARDS.map((card) => {
              ...
              return (
                <div
                  key={card.id}
                  className="bg-slate-50 border border-slate-300 rounded-[28px] p-8 md:p-10 text-left transition-all duration-300 hover:bg-white hover:shadow-xl hover:border-cyan-300 group relative flex flex-col justify-between h-full shadow-md min-h-[300px]"
                >
