        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-brand hover:text-white transition-colors">
                <FiFacebook />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-brand hover:text-white transition-colors">
                <FiTwitter />
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li><Link to="/services" className="text-gray-400 hover:text-brand transition-colors">Our Services</Link></li>
              <li><Link to="/stock-sales" className="text-gray-400 hover:text-brand transition-colors">Stock & Sales</Link></li>
              <li><Link to="/web-order" className="text-gray-400 hover:text-brand transition-colors">Web Order</Link></li>
              <li><Link to="/partner" className="text-gray-400 hover:text-brand transition-colors">Partner With Us</Link></li>
              <li><Link to="/career" className="text-gray-400 hover:text-brand transition-colors">Career Opportunities</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li className="flex items-start gap-3 text-gray-400">
                ...
                <span>123 Pharma Avenue, Medical District, City, State, 123456</span>
              </li>
